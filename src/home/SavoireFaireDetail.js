...
const SavoireFaireDetail =  (props) => {
    ...
    useEffect(() => {
     ...
     setData(ActuData.find(x => x._id == id))
               ...
               <Container  maxWidth={false}>
                        <Grid container spacing={2}>
                             <Grid item lg={4} md={6}  xs={12}>
                                <Box mt={15} mb={1}>
                                    <ListPost lien="savoire-faire-details" title="Savoire-faire" data={ActuData} />
                                 </Box>
                             </Grid>
...
export default SavoireFaireDetail
